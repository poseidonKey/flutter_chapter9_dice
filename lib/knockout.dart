...
class KnockOutScreen extends StatefulWidget {
  const KnockOutScreen({Key? key}) : super(key: key);
...
class _KnockOutScreenState extends State<KnockOutScreen> {
  int _playerScore = 0;
  int _aiScore = 0;
  late RiveAnimationController _animation1;
  late RiveAnimationController _animation2;
  late Artboard _artboard1;
  late Artboard _artboard2;
  ...
  void _loadRiveFile() async {
    ...
    final file2 = RiveFile.import(bytes);
    setState(() {
      _artboard1 = file.mainArtboard..addController(_animation1);
      _artboard2 = file2.mainArtboard..addController(_animation2);
    });
  }
...
class GameText extends StatelessWidget {
  ...
  const GameText(this.text, this.color, this.isBordered);
